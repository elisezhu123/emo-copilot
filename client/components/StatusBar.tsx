  ...
  return (
    <div className={`flex justify-between items-center w-full h-5 px-5 py-5 ${isDraggable ? 'cursor-move' : ''}`} {...dragHandlers}>
      ...
      <div className="flex justify-center items-center gap-1.5">
        ...
        <span className="text-[#3A2018] text-center font-inter text-[9px] font-normal leading-normal">
          Emo-Copilot Active
        </span>
      </div>
      ...
      {showTemperature && temperature && (
        <div className="flex justify-center items-center gap-1.5">
          ...
          <span
            className="text-[#3A2018] text-center font-inter text-[9px] font-normal leading-normal cursor-pointer hover:text-blue-600"
            onClick={() => {
      ...
      <div className="flex w-[101px] justify-end items-center gap-1 flex-shrink-0">
        <span className="text-[#3A2018] text-center font-inter text-[9px] font-normal leading-normal">
