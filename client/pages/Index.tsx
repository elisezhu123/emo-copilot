  ...
  return (
    <div className="min-h-screen bg-white px-3 py-2 max-w-md mx-auto lg:max-w-4xl xl:max-w-6xl">
      ...
      {showCoolingEmoji && (
        <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-50">
          <div className="animate-bounce">
            {/* Fan emoji from Figma design */}
            <div className="flex w-32 h-20 lg:w-40 lg:h-24 justify-center items-center bg-white rounded-xl shadow-lg">
              <svg className="w-24 h-12 lg:w-30 lg:h-14 flex-shrink-0" viewBox="0 0 380 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_17_194)">
                  <path fillRule="evenodd" clipRule="evenodd" d="M114.125 73.9234C118.45 69.4939 125.59 69.4418 129.967 73.8192C134.397 78.1445 134.449 85.2317 130.071 89.6612C121.004 98.8329 102.4 106.702 80.4087 108.786C63.0554 110.454 43.1486 108.682 23.8672 101.282C18.0828 99.0935 15.2166 92.5795 17.4053 86.8472C19.594 81.0628 26.0559 78.1966 31.8404 80.3853C47.526 86.4303 63.8892 87.8373 78.2721 86.4824C94.9479 84.8669 108.289 79.76 114.021 73.9234H114.125Z" fill="#3A2018"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M132.937 156.417C130.228 154.905 129.29 151.466 130.801 148.808C132.312 146.098 135.751 145.16 138.409 146.672C155.033 156.052 164.621 152.196 173.533 148.652C179.056 146.411 184.372 144.327 190.938 144.327C197.504 144.327 202.819 146.463 208.343 148.652C217.254 152.248 226.791 156.104 243.467 146.672C246.177 145.16 249.564 146.098 251.075 148.808C252.586 151.518 251.648 154.905 248.939 156.417C227.573 168.454 215.483 163.608 204.174 159.022C199.693 157.25 195.42 155.479 190.938 155.479C186.456 155.479 182.183 157.198 177.702 159.022C166.393 163.556 154.251 168.454 132.937 156.417Z" fill="#3A2018"/>
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M7.3478 29.5762C4.42953 30.5663 1.2507 28.9508 0.260577 26.0325C-0.72955 23.1143 0.88592 19.9354 3.80419 18.9453L5.94077 18.2158C26.2644 11.4412 76.1876 -5.18249 111.155 2.32162C116.001 3.36386 120.639 4.71877 124.86 6.5948C129.29 8.47083 133.354 10.868 136.95 13.8905C139.347 15.8707 139.66 19.4143 137.628 21.8115C135.647 24.2086 132.104 24.5213 129.707 22.4889C126.997 20.196 123.87 18.3721 120.379 16.913C116.783 15.3496 112.874 14.2031 108.758 13.3172C76.813 6.38635 28.9742 22.3326 9.5365 28.8466L7.3478 29.5762Z" fill="#3A2018"/>
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M376.144 18.9454C379.062 19.9355 380.677 23.0622 379.687 26.0326C378.697 28.9509 375.57 30.5663 372.6 29.5762L370.411 28.8466C350.974 22.3848 303.187 6.43853 271.138 13.3173C267.021 14.2032 263.113 15.3497 259.517 16.913C256.078 18.4243 252.899 20.2482 250.189 22.489C247.792 24.4692 244.248 24.1566 242.268 21.8115C240.288 19.4144 240.601 15.8708 242.998 13.8905C246.594 10.868 250.658 8.47089 255.088 6.59486C259.361 4.77095 263.999 3.36392 268.793 2.32169C303.76 -5.18243 353.631 11.4413 373.903 18.2158L376.04 18.9454H376.144Z" fill="#3A2018"/>
                </g>
                <defs>
      ...
      {showLightingEmoji && (
        <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-50">
          <div className="animate-bounce">
            {/* Light bulb emoji from Figma design */}
            <div className="flex w-32 h-20 lg:w-40 lg:h-24 justify-center items-center bg-white rounded-xl shadow-lg">
              <svg className="w-24 h-12 lg:w-30 lg:h-14 flex-shrink-0" viewBox="0 0 400 226" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_17_236)">
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M226.872 202.859C222.317 195.411 214.869 189.946 205.653 189.946C196.437 189.946 188.667 195.679 184.113 203.342C171.735 224.346 240.322 224.721 226.872 202.859Z" fill="#FF8B7E"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M14.0388 63.1138C11.3061 66.4896 6.32283 67.079 2.8935 64.2927C-0.482256 61.5599 -1.01809 56.5767 1.71466 53.1473C10.7703 41.9484 21.4333 29.8386 36.008 19.9792C50.797 10.0663 69.3905 2.51104 94.0924 0.689201C98.4327 0.367701 102.237 3.68987 102.559 8.03012C102.88 12.3704 99.5579 16.1748 95.2177 16.4963C73.7307 18.0502 57.6021 24.5874 44.9029 33.1607C31.9893 41.8948 22.3443 52.8794 14.0924 63.1138H14.0388Z" fill="#3A2018"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M302.05 37.501C298.513 40.073 293.583 39.2693 291.011 35.7863C288.439 32.2498 289.243 27.3202 292.726 24.8017C301.675 18.3181 322.894 6.63697 348.078 8.99464C363.938 10.495 381.246 17.5144 397.75 34.7147C400.75 37.8761 400.697 42.8593 397.535 45.9136C394.374 48.9143 389.391 48.8607 386.336 45.6993C372.833 31.6604 359.062 25.9806 346.577 24.7482C326.43 22.8192 309.23 32.3034 301.996 37.5546L302.05 37.501Z" fill="#3A2018"/>
                  <path d="M98.3004 162.38C124.138 151.603 136.348 121.921 125.572 96.0834C114.795 70.2454 85.1132 58.0357 59.2753 68.8122C33.4373 79.5886 21.2275 109.271 32.004 135.109C42.7805 160.947 72.4624 173.156 98.3004 162.38Z" fill="#3A2018"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M95.0904 77.9029C108.486 77.9029 119.31 88.7267 119.31 102.123C119.31 115.518 108.486 126.342 95.0904 126.342C81.6946 126.342 70.8707 115.518 70.8707 102.123C70.8707 88.7267 81.6946 77.9029 95.0904 77.9029Z" fill="white"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M55.2244 144.507C45.5258 144.507 37.7026 136.684 37.7026 126.985C37.7026 117.287 45.5258 109.464 55.2244 109.464C64.923 109.464 72.7461 117.287 72.7461 126.985C72.7461 136.684 64.923 144.507 55.2244 144.507Z" fill="white"/>
                  ...
                  <path fillRule="evenodd" clipRule="evenodd" d="M346.723 77.9029C360.119 77.9029 370.942 88.7267 370.942 102.123C370.942 115.518 360.119 126.342 346.723 126.342C333.327 126.342 322.503 115.518 322.503 102.123C322.503 88.7267 333.38 77.9029 346.723 77.9029Z" fill="white"/>
                  <path fillRule="evenodd" clipRule="evenodd" d="M306.857 144.507C297.158 144.507 289.335 136.684 289.335 126.985C289.335 117.287 297.158 109.464 306.857 109.464C316.555 109.464 324.378 117.287 324.378 126.985C324.378 136.684 316.555 144.507 306.857 144.507Z" fill="white"/>
                ...
                <defs>
                  <clipPath id="clip0_17_236">
                    <rect width="400" height="224.622" fill="white" transform="translate(0 0.689209)"/>
                  </clipPath>
                </defs>
              </svg>
            </div>
